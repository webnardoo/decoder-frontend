// src/app/app/billing/plan/page.tsx
"use client";
          ...
          <section className="mt-10">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mt-4 text-sm text-zinc-400 leading-relaxed">
                ...
                Podem ser adquiridos de forma independente ou como complemento
                ao seu plano mensal.
              </div>
            </div>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <div className="mt-1 text-sm text-zinc-200/95">
                            <span className="font-semibold">{a.credits}</span>{" "}
                            créditos
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <div className="mt-1 text-sm text-zinc-400">
                      Pagamento via Pix. Créditos adicionados automaticamente
                      após confirmação.
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                  {plans
                    ...
                    .map((p) => {
                      ...
                      const canUseCycle = p.billingCycles?.includes("monthly");
                          ...
                          <div className="relative p-5 md:p-6 flex flex-col min-h-[420px]">
                            ...
                            <div className="mt-5">
                              <button
                                ...
                                onClick={() =>
                                  void onSubscribe(p.planId, p.code, planDisplayName)
                                }
                                type="button"
                                style={{
                                  background: ui.ctaBg,
